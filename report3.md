...
<br> __Source__ : `https://man7.org/linux/man-pages/man1/find.1.html` <br>
...
technical/plos
```
This command specifies the type of file to search for.`type` is replaced by `-d` here which denotes that directories are being searched for in the `technical/` directory.
...
technical/plos/pmed.0020281.txt
```
This command specifies the type of file to search for.`type` is replaced by `-f` here which denotes that files are being searched for in the `technical/` directory.
...
technical/biomed/rr74.txt
```
This command prints out the pathnames of the files and directories found in `technical/biomed/`

<br> _Example 2_ <br>
Code:
```
find technical/government/  -print
```
Output:
```
technical/government/
...
technical/government/Post_Rate_Comm/WolakSpeech_usps.txt
```
This command prints out the pathnames of the files and directories found in `technical/government/`
...
Code:
```
find technical/ -newer technical/plos/pmed.0020278.txt
```
Output:
```
technical/plos/pmed.0020281.txt
```
This command prints out the name of the file (`technical/plos/pmed.0020281.txt` here) that was modified after the specified file (`technical/plos/pmed.0020278.txt`).

<br> _Example 2_ <br>
Code:
```
find technical/ -newer technical/plos/pmed.0020274.txt
```
Output:
```
technical/plos
...
technical/plos/pmed.0020281.txt
```
This command prints out the name of the files that was modified after the specified file (`technical/plos/pmed.0020274.txt`).
